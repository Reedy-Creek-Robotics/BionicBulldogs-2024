...
fun speciminSide(drive: DriveShim): TrajectorySequence
{
	...
	//v2 spec auto
		.lineToLinearHeading(Pose2d(47.0, -45.0, Math.toRadians(90.0))).waitSeconds(1.0)
		.lineToConstantHeading(Vector2d(59.0, -45.0)).waitSeconds(1.0)
		.lineToConstantHeading(Vector2d(68.0, -45.0)).waitSeconds(1.0)
		.lineToConstantHeading(Vector2d(45.0, -60.0)).waitSeconds(1.0)
		.lineToLinearHeading(Pose2d(0.0, -28.0, Math.toRadians(-90.0))).waitSeconds(1.0)
		.lineToLinearHeading(Pose2d(45.0, -60.0, Math.toRadians(90.0))).waitSeconds(1.0)
		.lineToLinearHeading(Pose2d(0.0, -28.0, Math.toRadians(-90.0))).waitSeconds(1.0)
		.lineToLinearHeading(Pose2d(45.0, -60.0, Math.toRadians(90.0))).waitSeconds(1.0)
		.lineToLinearHeading(Pose2d(0.0, -28.0, Math.toRadians(-90.0))).waitSeconds(1.0)
		.lineToConstantHeading(Vector2d(45.0, -60.0)).waitSeconds(1.0)
	//v1 spec auto
		...
		.lineToLinearHeading(Pose2d(0.0, -28.0, Math.toRadians(-90.0))).waitSeconds(1.0)
		.lineToConstantHeading(Vector2d(38.0, -55.0))*/
		.build();
}
...
fun sampleSide(drive: DriveShim): TrajectorySequence
{
	return drive.trajectorySequenceBuilder(Pose2d(0.0, -60.0, Math.toRadians(-90.0)))
		...
		.splineToLinearHeading(Pose2d(-34.0, -24.0, Math.toRadians(180.0)), Math.toRadians(90.0)).waitSeconds(1.0)
...
fun main()
{
	...
	val bot = botBuilder.followTrajectorySequence {drive: DriveShim -> speciminSide(drive) };
