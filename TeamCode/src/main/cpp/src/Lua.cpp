...
Java_org_firstinspires_ftc_teamcode_opmodeloader_OpmodeLoader_internalInit(JNIEnv *env,
                                                                           jobject thiz,
                                                                           jobject stdlib) {
    FuncStat::env = env;
...
Java_org_firstinspires_ftc_teamcode_opmodeloader_OpmodeLoader_start(JNIEnv *env, jobject thiz,
                                                                    jstring name,
                                                                    int recognition) {
    lua_settop(l, 0);
    FuncStat::obj = thiz;
...
Java_org_firstinspires_ftc_teamcode_opmodeloader_OpmodeLoader_update(JNIEnv *env, jobject thiz,
                                                                     double deltaTime,
                                                                     double elapsedTime) {
...
extern "C" JNIEXPORT void JNICALL
Java_org_firstinspires_ftc_teamcode_opmodeloader_OpmodeLoader_stop(JNIEnv *env, jobject thiz) {
    lua_close(l);
    l = nullptr;
}
...
void callNextDispMarker(std::string str) {
    if (str == "") {
        dispMarkerInd++;
        str = std::to_string(dispMarkerInd);
    }
...
extern "C" JNIEXPORT void JNICALL
Java_org_firstinspires_ftc_teamcode_opmodeloader_LuaFunctionBuilder_setCurrentObject(
...
extern "C" JNIEXPORT void JNICALL
Java_org_firstinspires_ftc_teamcode_opmodeloader_LuaFunctionBuilder_addFunction(
...
extern "C" JNIEXPORT void JNICALL
Java_org_firstinspires_ftc_teamcode_opmodeloader_LuaFunctionBuilder_newClass(JNIEnv *env,
                                                                             jobject thiz) {
    startClass();
}

extern "C" JNIEXPORT void JNICALL
Java_org_firstinspires_ftc_teamcode_opmodeloader_LuaFunctionBuilder_endClass(JNIEnv *env,
                                                                             jobject thiz,
                                                                             jstring name) {
