...
@Config
public final class TwoDeadWheelLocalizer2 implements Localizer
{
    ...
    public TwoDeadWheelLocalizer2(HardwareMap hardwareMap, IMU imu2, double inPerTick, Pose2d pose)
    {
        ...
        imu = hardwareMap.get(SparkFunOTOS.class, "imu2");
        imu.setAngularUnit(AngleUnit.RADIANS);
        imu.setAngularScalar(1.0);
        imu.calibrateImu();
        imu.resetTracking();
        imu.setPosition(new SparkFunOTOS.Pose2D());
    ...
    public PoseVelocity2d update()
    {
        ...
        double angle = imu.getPosition().h;
        // Use degrees here to work around https://github.com/FIRST-Tech-Challenge/FtcRobotController/issues/1070
        double rawHeadingVel = imu.getVelocity().h;

        //FlightRecorder.write("TWO_DEAD_WHEEL_INPUTS", new TwoDeadWheelInputsMessage(parPosVel, perpPosVel, angle, rawHeadingVel));
