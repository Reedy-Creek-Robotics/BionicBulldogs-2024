 ...
 */
@TeleOp(group = "drive")
public class LocalizationTestFR extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        while (!isStopRequested()) {
            ...
            double f = (forward * Math.cos(-heading) - strafe * Math.sin(-heading));
            double r = (forward * Math.sin(-heading) + strafe * Math.cos(-heading));
